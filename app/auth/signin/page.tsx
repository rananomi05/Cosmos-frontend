...
const SignInPage = () => {
  ...
  return (
    <div id="signin" className="min-h-screen flex items-center justify-center bg-[#111827] p-4 relative overflow-hidden">
        ...
        <div className="bg-[#1b2130] backdrop-blur-xl rounded-3xl shadow-2xl p-8 space-y-6 border border-white/20">
          ...
          <div className="text-center pt-4 border-t border-gray-200">
            <p className="text-sm text-white">
              ...
              <Link href={ROUTES.SIGNUP} className="text-[#7C3AED] hover:text-purple-700 font-semibold">
                Sign up for free
              </Link>
            </p>
          </div>
